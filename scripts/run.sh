...
DEFAULT_TOPIC="A log file analyzer that parses structured and unstructured log files to extract error patterns, frequency distributions, and timeline visualizations. Support common log formats (Apache, nginx, syslog, JSON lines)."
DEFAULT_CONTEXT=""
